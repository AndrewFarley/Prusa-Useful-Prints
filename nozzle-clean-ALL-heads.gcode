...
M104 S250                   ; Set the temperature of the selected extruder to 250°C (async/background/non-validating)
T2                          ; Select the third extruder
M104 S250                   ; Set the temperature of the selected extruder to 250°C (async/background/non-validating)
T1                          ; Select the second extruder
M104 S250                   ; Set the temperature of the selected extruder to 250°C (async/background/non-validating)
